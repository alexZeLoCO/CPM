...
public class TareaMensa extends Tarea{
   ...
   @Override 
    public void infoPromo (float descuento, float porDescuento, Color c) {
	this.VEnvio.lDescuento.setText(""+descuento);
	this.VEnvio.pbPorDescuento.setValue((int) porDescuento);
	this.VEnvio.lDescuento.setBackground(c);
	this.VEnvio.lDescuento.repaint();
    }
	...
	this.VEnvio.lDescuento.setBackground(Color.WHITE);
	this.VEnvio.lDescuento.repaint();
    }
