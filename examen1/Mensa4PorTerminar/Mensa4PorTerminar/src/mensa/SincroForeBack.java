...
public interface SincroForeBack {
    ...
    void infoPromo(float descuento,float porDescuento,Color C);
    // descuento   : descuento que se está aplicando
    // porDescuento: Porcentaje de descuento que se está aplicando
    // C           : Color para el texto  
