...
public class Envio extends javax.swing.JFrame {
    ...
    public Envio() {
        ...
        this.tarea = new TareaMensa (this);
    }
	...
	if (this.cbPagoAplazado.isSelected()) {
		this.tarea.setPagoAplazado(Integer.parseInt(this.comboMesesPagoAplazado.getSelectedItem().toString()));
	} else {
		this.tarea.setPagoAplazado(-1);
	}
	this.tarea.setSeguro(this.cbSeguro.isSelected());
	this.thread = new Thread () {
		@Override
		public void run () {
			Envio.this.tarea.Run();
		}
	};
	this.thread.start();
	this.bPararCalculo.setEnabled(true);
	this.bCalcularImporte.setEnabled(false);
    ...
    private void bPararCalculoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bPararCalculoActionPerformed
        // TODO add your handling code here:
	this.tarea.Stop();
	this.bCalcularImporte.setEnabled(true);
