 ...
 */
public class PostPartida extends javax.swing.JDialog {

	/**
	 * Creates new form PostPartida
	 */
	...
	private void initComponents() {
		...
		LT_Entidades = new javax.swing.JList<>();
		LB_Ganadores = new javax.swing.JLabel();

		setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
		setTitle("Meroquest | Informe Postpartida");

		jLabel1.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
		jLabel1.setText("Postgame");

		jLabel2.setText("Winners");

		jLabel3.setText("Final result:");

		jScrollPane1.setViewportView(LT_Entidades);

		LB_Ganadores.setText("Monstruos");
	...
	public void showDialog(Game g) {
		...
		javax.swing.DefaultListModel<String> m = (javax.swing.DefaultListModel<String>) this.LT_Entidades.getModel();
		m.clear();
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(PostPartida.class.getName()).log(java.util.logging.Level.SEVERE, null,
					ex);
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
				PostPartida dialog = new PostPartida(new javax.swing.JFrame(), true);
	...
	private javax.swing.JLabel LB_Ganadores;
	private javax.swing.JList<String> LT_Entidades;
